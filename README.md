...
- **Editable Caption Graphics**: Bulk placement of the bundled Premiere graphic template with cue-accurate timing. Each resulting clip exposes editable Unicode text, font, style, and size in Premiere's Properties panel and accepts normal Premiere effects. See [MOGRT_CAPTION_TEMPLATE.md](MOGRT_CAPTION_TEMPLATE.md).
